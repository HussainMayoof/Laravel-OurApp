...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.6.2/dist/css/bootstrap.min.css" integrity="sha384-xOolHFLEh07PJGoPkLv1IbcEPTNtaed2xpHsD9ESMhqIYd0nLMwNLD69Npy4HI+N" crossorigin="anonymous">    <script defer src="https://use.fontawesome.com/releases/v5.5.0/js/all.js" integrity="sha384-GqVMZRt5Gn7tB9D9q7ONtcp4gtHIUEW/yG7h98J7IpE3kpi+srfFyyB/04OV6pG0" crossorigin="anonymous"></script>
        ...
        <form action="/login" method="POST" class="mb-0 pt-2 pt-md-0">
          ...
          <div class="row align-items-center">
            <div class="col-md mr-0 pr-md-0 mb-3 mb-md-0">
              <input value ="{{old('loginusername')}}" name="loginusername" class="form-control form-control-sm input-dark" type="text" placeholder="Username" autocomplete="off" />
              @error('loginusername')
              <p class="m-o small alert alert-danger shadow-sm mt-1">{{$message}}</p>
              @enderror
            </div>
            <div class="col-md mr-0 pr-md-0 mb-3 mb-md-0">
