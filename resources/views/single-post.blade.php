<x-layout :doctitle="$post->title">
    <div class="container py-md-5 container--narrow">
        ...
        <p class="text-muted small mb-4">
          ...
          Posted by <a href="/profile/{{$post->user->username}}">{{$post->user->username}}</a> on {{$post->created_at->format("j/n/Y")}} at {{$post->created_at->setTimezone('Asia/Bahrain')->format("H:i:s")}}
        </p>
